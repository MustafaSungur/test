...
@Component({
  selector: 'app-karmed-sidebar-left-dark',
  standalone: true, // standalone olduğu varsayılarak
  imports: [NgClass, CommonModule, FormsModule],
  templateUrl: './karmed-sidebar-left-dark.component.html',
  styleUrl: './karmed-sidebar-left-dark.component.scss',
})
export class KarmedSidebarLeftDarkComponent {
